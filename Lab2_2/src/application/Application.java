...
public class Application {
	...
	public static void main(String[] args) {
		...
		ACCOUNT_SERVICE_IMPL.registerAccountCreatedObserver(logger);
		ACCOUNT_SERVICE_IMPL.registerAccountChangedObserver(logger);

		ACCOUNT_SERVICE_IMPL.registerAccountCreatedObserver(smsSender);
		ACCOUNT_SERVICE_IMPL.registerAccountChangedObserver(smsSender);

		ACCOUNT_SERVICE_IMPL.registerAccountCreatedObserver(emailSender);
